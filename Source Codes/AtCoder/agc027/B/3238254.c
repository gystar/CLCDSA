...
long long seg(long long st,long long fi){
  return rw[fi]-rw[st-1];
}

int main(void){
    long long i,j,n,m,k,a[524288],b,c,h,w,r=llinf,l,t,x,fl,nr;
    double d;
    char s[524288];
    scanf("%lld%lld",&n,&x);
    for(i=1;i<=n;i++){

...
int *imalloc(int n);
int **imalloc2(int n);
long int *lmalloc(int n);
long int **lmalloc2(int n);
long long int *llmalloc(int n);
long long int **llmalloc2(int n);
double *dmalloc(int n);
double **dmalloc2(int n);
char *cmalloc(int n);
char **cmalloc2(int n);
...
int icmpu(const void *a,const void *b);
int lcmpu(const void *a,const void *b);
int llcmpu(const void *a,const void *b);
int dcmpu(const void *a,const void *b);
int ccmpu(const void *a,const void *b);
int scmpu(const void *a,const void *b);
int icmpd(const void *a,const void *b);
int lcmpd(const void *a,const void *b);
int llcmpd(const void *a,const void *b);
int dcmpd(const void *a,const void *b);
int ccmpd(const void *a,const void *b);
int scmpd(const void *a,const void *b);
void isortu(int *a,int n);
void lsortu(long int *a,int n);
void llsortu(long long int *a,int n);
void dsortu(double *a,int n);
void csortu(char *a,int n);
void ssortu(char **a,int n);
void isortd(int *a,int n);
void lsortd(long int *a,int n);
void llsortd(long long int *a,int n);
void dsortd(double *a,int n);
void csortd(char *a,int n);
void ssortd(char **a,int n);
struct SLN *newsln(int d);
void iisl(struct SLN **h,int d,int p);
void dfsl(struct SLN **h,int p);
int sll(struct SLN *h);
struct GM *newgm(int v);
/*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
//????
/*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/

...
int main(void){
    int i,q,a,b,c,d,sl,tl;
    int srw[2][131072]={0},trw[2][131072]={0},sp,tp;
    ...
    for(i=1;i<=q;i++){
        ...
        sp=srw[0][b]-srw[0][a-1];
        sp+=(srw[1][b]-srw[1][a-1])*2;
        tp=trw[0][d]-trw[0][c-1];
        tp+=(trw[1][d]-trw[1][c-1])*2;
        if(sp%3==tp%3){printf("YES\n");}else{printf("NO\n");}
    }
    return 0;

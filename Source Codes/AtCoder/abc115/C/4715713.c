...
int main(void)
{
  int i, j, n, m, k, a[524288], b, c, h, w, r = inf, l, t;
  double d;
  char s[524288];
  scanf("%d%d", &n, &k);
  for (i = 0; i < n; i++)
  ...
  printf("%d\n", r);
  return 0;
} ./Main.c:27:5: warning: conflicting types for built-in function ‘round’
 int round(int a, int b)
     ^
./Main.c:35:5: warning: conflicting types for built-in function ‘ceil’
 int ceil(int a, int b)
     ^
./Main.c:80:5: warning: conflicting types for built-in function ‘pow’
 int pow(int a, int b)
     ^

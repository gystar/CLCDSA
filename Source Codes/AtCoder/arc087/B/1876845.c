...
ull solve () {
	...
	// qsort(a, xpath, sizeof(ull), pullcomp);
	// qsort(b, ypath, sizeof(ull), pullcomp);
	vsa = sllabs(vsa, 0);
	vsb = sllabs(vsb, 0);

...
int main(void){
    ...
    for(i=k-1;i>=0;i--){
        t++;
        if(d%2==1){
            if(t%2==1 && b[i]==0){printf("Takahashi\n");return 0;}
            if(t%2==0 && b[i]==1){printf("Aoki\n");return 0;}
        }
        else{
            if(t%2==1 && b[i]==1){printf("Takahashi\n");return 0;}
            if(t%2==0 && b[i]==0){printf("Aoki\n");return 0;}
        }
    }
    if(d%2==1){printf("Aoki\n");}else{printf("Takahashi\n");}
    return 0;
